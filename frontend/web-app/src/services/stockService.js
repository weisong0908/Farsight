...
export default {
  ...
  async getPreviousClose(ticker, accessToken) {
    return await axios.get(
      `${process.env.VUE_APP_BACKEND}/stocks/previous/${ticker}`,
      {
        headers: {
          Authorization: `Bearer ${accessToken}`
        }
  ...
  async getPreviousPrice(ticker) {
    ...
    return new Promise(resolve => {
      resolve({
        ...
        status: "OK",
        request_id: "30b38ef92922c9aa53616cf912653ad4",
        count: 1
      });
    });
  },
  async getTrend(ticker) {
    ...
    return new Promise(resolve => {
      resolve({
        ...
        status: "DELAYED",
        request_id: "8f1a65e19b06be95b409f90f1bad5c56",
        count: 121
      });
    });
  }
