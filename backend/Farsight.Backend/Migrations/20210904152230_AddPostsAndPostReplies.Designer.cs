...
namespace Farsight.Backend.Migrations
{
    ...
    [Migration("20210904152230_AddPostsAndPostReplies")]
    partial class AddPostsAndPostReplies
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Farsight.Backend.Models.HoldingCategory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Farsight.Backend.Models.Post", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Farsight.Backend.Models.PostReply", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Farsight.Backend.Models.Trade", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Date = new DateTime(2021, 9, 4, 23, 22, 29, 574, DateTimeKind.Local).AddTicks(470),
                            Fees = 0m,
                        ...
                        new
                        {
                            ...
                            Date = new DateTime(2021, 9, 4, 15, 22, 29, 579, DateTimeKind.Utc).AddTicks(170),
                            Fees = 1m,
            ...
            modelBuilder.Entity("Farsight.Backend.Models.PostReply", b =>
                {
                    b.HasOne("Farsight.Backend.Models.Post", "Post")
                        .WithMany("Replies")
            ...
            modelBuilder.Entity("Farsight.Backend.Models.Portfolio", b =>
                {
                    b.Navigation("HoldingCategories");
